  ...
  return (
    <div className="min-h-screen min-w-screen flex flex-col items-center justify-between bg-gradient-to-br from-gray-800 via-gray-900 to-black">
      ...
      <div className="flex w-11/12 mt-12 p-8 h-[800px] rounded-lg shadow-md glass-effect border border-gray-700">
                    ...
                    (selectedCategories.length <= 4 ? (
                      ...
                      <>
                        <button
                          ...
                          className="flex font-semibold items-center justify-center px-11 space-x-2 w-8 h-8 mt-1 mb-1 bg-indigo-600 text-white rounded-full shadow-md hover:bg-indigo-700"
                        ...
                        {isModalOpen && (
                          <div className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full flex ">
                            <div className="relative p-4 w-full max-w-xl max-h-full">
                              <div className="relative bg-white rounded-lg shadow glass-effect bg-gradient-to-br from-gray-800 via-gray-900 to-black border-4 border-indigo-700">
        ...
        {isMenuOpen && (
          <div className="absolute top-0 right-0 border-4 border-indigo-700 h-[800px] w-[400px] bg-gray-900 p-4 rounded-l-lg shadow-xl flex flex-col space-y-4 justify-center">
            <Filters
